            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <div class="text-center logodiv">
                        <a href="index.html" class="logo"><img src="assets/images/LolaMora.png" style="width: 90px; vertical-align: text-bottom; border-radius: 10px; opacity: .7;"><span>  Lenceria </span> </a>
                    </div>
                </div>
